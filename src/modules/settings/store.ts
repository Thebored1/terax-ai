...
const KEY_AGENT_AUTO_APPROVE = "agentAutoApprove";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    agentAutoApprove:
      get<boolean>(KEY_AGENT_AUTO_APPROVE) ??
      DEFAULT_PREFERENCES.agentAutoApprove,
    shortcuts:
...
export async function setAgentAutoApprove(value: boolean): Promise<void> {
  await writePref(KEY_AGENT_AUTO_APPROVE, value);
}
...
export async function onPreferencesChange(
  ...
  const map: Record<string, PrefKey> = {
    ...
    [KEY_AGENT_AUTO_APPROVE]: "agentAutoApprove",
